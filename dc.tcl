...
#設定40nm製程路徑
set search_path      "/EDA_Tools/CBDK/CBDK_TSMC40_Arm_f2.0/CIC/SynopsysDC/db/sc9_base_rvt/  $search_path"
...
# current_design $Top
analyze -format verilog { 	./phase.v}
elaborate $Top
